  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        /* Orange retired — remapped to mint so any legacy `*-orange-*`
           class renders mint (palette = ink + mint + light). */
        orange: {
          50:  '#ecfbf6',
          100: '#d4f5ea',
          200: '#a8ecd5',
      ...
      boxShadow: {
        ...
        'orange':       '0 8px 20px rgba(43,191,139,0.25)',
        'orange-hover': '0 12px 28px rgba(43,191,139,0.35)',
        'orange-badge': '0 8px 18px rgba(43,191,139,0.32)',
